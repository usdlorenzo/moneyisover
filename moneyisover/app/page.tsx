...
export default function Home() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("moneyisover-box-positions-v2");
    if (saved) {
      try {
  ...
  useEffect(() => {
    localStorage.setItem("moneyisover-box-positions-v2", JSON.stringify(positions));
  }, [positions]);
  ...
  function resetLayout() {
    localStorage.removeItem("moneyisover-box-positions-v2");
    ...
    <main className="min-h-screen overflow-hidden bg-black text-white">
      ...
      <section className="relative z-10 flex min-h-screen items-center justify-center p-5">
        <div className="relative h-[850px] w-full max-w-[1450px] overflow-hidden rounded-[34px] border border-white/15 bg-black/5 shadow-[0_40px_140px_rgba(0,0,0,0.8)] backdrop-blur-[1px]">
          ...
          <Box pos={positions.time} onMouseDown={(e) => startDrag("time", e)} w="190px" h="95px">
          ...
          <Box pos={positions.weather} onMouseDown={(e) => startDrag("weather", e)} w="260px" h="135px">
          ...
          <Box pos={positions.prices} onMouseDown={(e) => startDrag("prices", e)} w="250px" h="165px">
            <div className="flex justify-between">
          ...
          <Box pos={positions.hero} onMouseDown={(e) => startDrag("hero", e)} w="360px" h="225px">
          ...
          <Box pos={positions.courses} onMouseDown={(e) => startDrag("courses", e)} w="350px" h="185px">
          ...
          <Box pos={positions.reminders} onMouseDown={(e) => startDrag("reminders", e)} w="350px" h="155px">
          ...
          <Box pos={positions.discussions} onMouseDown={(e) => startDrag("discussions", e)} w="520px" h="385px">
          ...
          <Box pos={positions.actions} onMouseDown={(e) => startDrag("actions", e)} w="350px" h="220px" p="p-2">
          ...
          <Box pos={positions.videos} onMouseDown={(e) => startDrag("videos", e)} w="500px" h="330px">
            <div className="mb-3 flex justify-between">
          ...
          <Box pos={positions.calendar} onMouseDown={(e) => startDrag("calendar", e)} w="250px" h="215px">
            <div className="mb-3 flex justify-between">
              <button>‹</button>
